;
; HFT.CMD FILE FOR HFT (Fast Task Builder)
; ON A RSTS/E SYSTEM
; USING OVERLAID FCS FROM SYSLIB
; CREATED BY SYSGEN3.CMD VERSION 03.04
;
; REG	01-AUG-87	UPDATE FOR RSX CHANGES
;
TKB:HFT/FM/ID/-FP/CP/MM,TKB:HFT/-SP/CR,TKB:HFT=TKB:HFTOVR/MP
TASK=...HFT
IDENT=H47.00		; Release V4.4
STACK=170
UNITS=8
ASG=TI:1
ASG=TI:2
...
PAR=GEN:0:70000
PRI=50
VSECT=DUMMY:160000:20000:4000 ; CREATE VSECT FOR FAST MAPPED WORK REGION
WNDWS=1			; WINDOW FOR VSECT
...
GBLDEF=T$KMAX:157700	; MAXIMUM TASK SIZE
