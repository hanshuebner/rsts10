$!******************************************************************************
$!
$! LBRBLD.COM - command file to build the RSX LBR libraries.
$!
$!******************************************************************************
$!
$!
...
$!
$ _ASSIGN/USER/REPLACE D:[170,63] SYSTEM
$ _ASSIGN/USER/REPLACE D:[170,63] LST
...
$! Set protections
$!
$ _SET FILE/PROT=40 SYSTEM:LBR.OLB
$!
$RUN LIB:TKB
@LBR:LBRBLD
$!
...
$EOD
$!
$ _DELETE/NOLOG SYSTEM:LBR.TSK
$ _DELETE/NOLOG SYSTEM:LBR.STB
$ _RENAME SYSTEM:LBR.SIL SYSTEM:LBR.TSK
$!
$EXIT:
$ _IF $SEVERITY .EQ. 1 THEN _WRITE 0 "LBRBLD completed successfully"
$ _IF $SEVERITY .NE. 1 THEN _WRITE 0 "LBRBLD completed with errors"
$!
$ _SET JOB/PRIORITY=-8
$ _exit
